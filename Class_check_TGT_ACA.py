...
"""
TGT_check = StartEndChecker("G:\\TE_manual_curation\\Software_develop\\Test_for_new_gap_and_crop_by_gap\\LTRRT_15_with_TGT.fasta",
                         6, 5695, start_pattern="TGT", end_pattern="ACA")
print(TGT_check.consensus_seq)
print(TGT_check.check_start_end())
print(TGT_check.check_and_update())
"""

...
class MultipleSequenceAlignmentCluster:
    ...
    def __init__(self, input_align_dis, output_dir, min_lines=5, max_cluster=2):
        """
    ...
    def determine_optimal_clusters(self, min_clusters=2, max_clusters=5):
        """
        Determine the optimal number of clusters using silhouette score
        :param min_clusters: num default 2, Minimum number of clusters to consider
        :param max_clusters: num default 5, Maximum number of clusters to consider
        """

        # Higher silhouette scores indicate better-defined clusters.
        # define a list to store the sihouette scores for different cluster numbers
        silhouette_scores = []
        ...
        # use the index to retrive the corresponding cluster number from 'list_k'
...
"""
test = MultipleSequenceAlignmentCluster("G:\\TE_manual_curation\\Software_develop\\test_column_cleaning\\Test_group.fa",
                                        "G:\\TE_manual_curation\\Software_develop\\test_column_cleaning\\Test_group_bed.bed",
                                        "G:\\TE_manual_curation\\Software_develop\\test_column_cleaning")
test.write_clustered_bed_files()
test.subset_alignment_dis()

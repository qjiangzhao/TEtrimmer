...
class CropEnd:
        ...
        for i in range(self.alignment.get_alignment_length()):
            ...
            for record in self.alignment:  # This will loop each sequences in alignment
                ...
                if nucleotide in proportions:
                    ...
                    self.proportions_dict[record.id].append(0)
    ...
    def find_positions(self):
        """
        :function find_positions: this function will define the start and end position for each sequence
...
for i in range(13,18):
    test_crop_end = CropEnd("G:\\TE_manual_curation\\Software_develop\\test_crop_end\\LINE_example.fasta_mafft_gap_filter.fasta", threshold=i)
    test_crop_end.write_to_file("G:\\TE_manual_curation\\Software_develop\\test_crop_end")
"""
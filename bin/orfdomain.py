...
def check_and_download(directory, filename, url):
    ...
    if not os.path.isfile(file_path):
        ...
        try:
            ...
            click.echo(f"\n{filename} was successfully downloaded and unpacked.\n")
        except Exception:
    ...
    if os.path.isfile(file_path):
        ...
        prcyan(f"{filename} found. The PFAM database cannot be downloaded by TETrimmer. "
               f"Please check your internet connection or download PFAM database manually.")
        return False

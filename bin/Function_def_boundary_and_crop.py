...
from Class_orf_domain_prediction import PlotPfam
...
def find_boundary_and_crop(bed_file, genome_file, output_dir, pfam_dir, seq_name, hmm_dir, cons_threshold=0.8,

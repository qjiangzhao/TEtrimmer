...
def find_boundary_and_crop(bed_file, genome_file, output_dir, pfam_dir, seq_name, cons_threshold=0.7,
                           ex_step_size=1000, max_extension=7000,
    ...
    :param cons_threshold: num default: 0.7, threshold used for consensus sequence generation
    ...
    bed_boundary = DefineBoundary(bed_fasta_mafft_gap_block_sim, threshold=cons_threshold, check_window=200, max_X=0.2)
            ...
            if re.match(pattern, file):
                ...
                if re.match(final_msa_pattern, file):
                    ...
                    final_con = final_con_object.con_generater_no_file(
                        os.path.join(proof_annotation_dir, unique_new_name))

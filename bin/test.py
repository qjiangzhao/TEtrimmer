import os
import unittest
from TE_Trimmer import main  # Import the main function
...
class TestMainFunction(unittest.TestCase):
    ...
    def test_main_function(self):
        ...
        if os.listdir(output_dir):
            click.echo(
                f"WARNING: The output directory {output_dir} is not empty. Please empty the output directory or "
                f"choose another empty directory.\n")
            # Stop the program if the output directory is not empty
            return
        ...
        self.assertEqual(len(files_in_folder), expected_file_count, f"Expected {expected_file_count} files in the directory {output_dir}/Single_fasta_files, but found {len(files_in_folder)} files.")
        ...
        # Check proof_annotation directory

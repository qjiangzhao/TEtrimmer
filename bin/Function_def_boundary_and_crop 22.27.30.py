...
def find_boundary_and_crop(bed_file, genome_file, output_dir, pfam_dir, seq_name, hmm_dir, skipped_file,
    ...
    while (if_left_ex or if_right_ex) and (left_ex <= max_extension and right_ex <= max_extension):
        ...
        bed_boundary = DefineBoundary(bed_fasta_mafft_cop_end_gap, threshold=ext_threshold,
                                      check_window=150, max_X=0.2, if_con_generater=False)
        ...
        if bed_boundary.if_continue:
            ...
            with open(skipped_file, "a") as f:
                f.write(seq_name + f"\telement is too short for TE Trimmer\n")
